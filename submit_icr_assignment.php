...
// SAFETY LOCK – JAN 2026
// Bulk ICR reassignment is disabled to prevent overwriting vessel-specific ICR edits.
// See: ICR Assignment Refactor – Action Plan (Phase 1)
...
die(
    'ICR bulk assignment has been temporarily disabled to protect vessel-specific inspections. ' .
    'Please use vessel-level ICR assignment.'
);
exit;
