...
<div class="alert alert-warning">
    <strong>Notice:</strong> Bulk ICR assignment is disabled to protect vessel-specific inspections.
    Please manage ICRs from the vessel ICR tab.
</div>
...
<div class="container">
    ...
    <?php if ($selected_vessel): ?>
        ...
        <form method="post" action="submit_icr_assignment.php">
            ...
            <button class="btn btn-secondary" disabled title="Bulk assignment is deprecated">
                Save Assignments
            </button>
