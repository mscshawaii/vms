...
<head>
    ...
    <title>Backfill Maintenance - VMS</title>
...
<div class="app-page">
    <div class="app-container">
        <div class="vms-card">
            <h1 class="h4 mb-3">Backfill Historical Maintenance</h1>
            ...
            <form method="post" action="submit_maintenance_backfill.php" class="row g-3">
                ...
                <div class="col-12">
                    <label class="form-label">Required Reason / Note</label>
                    <textarea name="note" class="form-control" rows="4" required placeholder="Explain why this historical completion is being backfilled."></textarea>
                </div>

                <div class="col-12 d-flex gap-2">
                    <button type="submit" class="btn btn-primary">Save Backfill</button>
